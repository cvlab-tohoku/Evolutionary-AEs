    ...
    def __init__(self, cgp, in_channel, n_class, imgSize):
        ...
        for name, in1 in self.cgp:
            if name == 'pool_max':
                ...
                out_size = 3
            elif name == 'DeConvolution1_1':
                out_size = 1
            elif name == 'DeConvolution3_1':
                out_size = 3
            elif name == 'DeConvolution3_3':
                out_size = 3
            elif name == 'Convolution32_1':
                out_size = 32
                kernel = 1
                pad_size = kernel // 2
        ...
        for j in range(len(self.cgp_inverse)):
            ...
            if self.cgp_inverse[j][0] == 'pool_max':
                ...
                out_size = 3
            elif self.cgp_inverse[j][0] == 'DeConvolution1_1':
                out_size = 1
            elif self.cgp_inverse[j][0] == 'DeConvolution3_1':
                out_size = 3
            elif self.cgp_inverse[j][0] == 'DeConvolution3_3':
                out_size = 3
            elif self.cgp_inverse[j][0] == 'Convolution32_1':
                out_size = 32
                kernel = 1
                pad_size = kernel // 2
                ...
                self.decode.append(nn.Conv2d(self.channel_num_d[self.cgp_inverse[j][1]], out_size, kernel, padding=pad_size, bias=False))
                self.channel_num_d[i] = out_size
            elif self.cgp_inverse[j][0] == 'Convolution64_1':
                out_size = 64
                kernel = 1
                pad_size = kernel // 2
                self.decode.append(nn.Conv2d(self.channel_num_d[self.cgp_inverse[j][1]], out_size, kernel, padding=pad_size, bias=False))
                ...
                self.decode.append(nn.Conv2d(self.channel_num_d[self.cgp_inverse[j][1]], out_size, kernel, padding=pad_size, bias=False))
                self.channel_num_d[i] = out_size
            elif self.cgp_inverse[j][0] == 'Convolution128_1':
                out_size = 128
                kernel = 1
                pad_size = kernel // 2
                self.decode.append(nn.Conv2d(self.channel_num_d[self.cgp_inverse[j][1]], out_size, kernel, padding=pad_size, bias=False))
        ...
        for j in range(1):
            if self.cgp_inverse[j][0] == 'Convolution1_1':
                ...
                kernel = 1
                pad_size = kernel //2
                self.decode.append(nn.ConvTranspose2d(self.channel_num_d[i-2], out_size, kernel, padding=pad_size))
                self.channel_num_d[-1] = out_size
            elif self.cgp_inverse[j][0] == 'DeConvolution3_1':
                out_size = 3
                kernel = 1
